...
public class RegisterTest extends Utility {
    ...
    public void userShouldRegisterAccountSuccessfully(){
       // WebElement registerButton= driver.findElement(By.linkText("Register"));//register button locator
        ...
        sendTextToElement(By.id("FirstName"),"Tom");

        sendTextToElement(By.id("LastName"),"Jerry");
        ...
        sendTextToElement(By.id("Password"),"TomJerry");

        sendTextToElement(By.id("ConfirmPassword"),"TomJerry");
